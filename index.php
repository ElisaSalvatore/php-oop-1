...
class Movie {
    ...
    public function getMovieInfos() {
        return
        "<div class='card col-5 p-5 mx-auto my-2 d-flex justify-content-around bg-light'>           
            <h2 class='py-1'> $this->title </h2> 
            <div><b> YEAR: </b> $this->year </div> 
            <div><b> GENRE: </b> $this->genre </div> 
...
$movies = [
    ...
    new Movie("Full Metal Jacket", "2001", "War, Drama, History", "Stanley Kubrick's take on the Vietnam War follows smart-aleck Private Davis (Matthew Modine), quickly christened 'Joker' by his foul-mouthed drill sergeant (R. Lee Ermey), and pudgy Private Lawrence (Vincent D'Onofrio), nicknamed 'Gomer Pyle', as they endure the rigors of basic training. Though Pyle takes a frightening detour, Joker graduates to the Marine Corps and is sent to Vietnam as a journalist, covering -- and eventually participating in -- the bloody Battle of Hué."),
];
...
<body class="bg-danger">
    ...
    <div class="container mx-auto">
       <h1 class="text-light p-5">MOVIES CARDS</h1>
        <div class="cards-container d-flex flex-wrap justify-content-beween">
            <?php
                foreach ($movies as $movie) { 
                    echo $movie->getMovieInfos();
                }
            ?>
        </div>
    </div>
